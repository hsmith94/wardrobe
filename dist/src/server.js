...
var PROJECT_ROOT_DIR = path_1.default.resolve(__dirname, '../..');
var BUNDLE_DIR = path_1.default.resolve(PROJECT_ROOT_DIR, './dist/frontend');
function startServer() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    server = new server_1.Server(express_1.default).configure({
                        appName: constants_1.APP_NAME,
                        port: constants_1.API_PORT,
                        basePath: constants_1.API_BASE_PATH,
                        commonMiddlewares: middlewares_1.MIDDLEWARES,
